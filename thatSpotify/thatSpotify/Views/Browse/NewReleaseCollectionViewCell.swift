...
//  thatSpotify
//
//  Created by Paulo Silva on 29/10/2021.
//
...
class NewReleaseCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        contentView.clipsToBounds = true // fix overflow
    }
    ...
    override func layoutSubviews() {
        ...
        // sizeToFit will appropriately size the labels to fit in the frame
    ...
    // ensure we don't leak state from the prior cell upon reuse
